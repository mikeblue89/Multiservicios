...
namespace Multiservicios.Data.Migrations
{
    ...
    [Migration("20201028231800_AddMoreFieldsToIdentityUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Multiservicios.Models.SolicitudCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Multiservicios.Models.Tickets", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ID_TIPO_SOLICITUD")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Multiservicios.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Multiservicios.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Multiservicios.Models.Tickets", b =>
                {
                    b.HasOne("Multiservicios.Models.Activo", "Activo")
                        .WithMany()
                        .HasForeignKey("ID_ACTIVO")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Multiservicios.Models.TipoSolicitud", "TipoSolicitud")
                        .WithMany()
                        .HasForeignKey("ID_TIPO_SOLICITUD")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Multiservicios.Models.Usuario", b =>
                {
                    ...
                    b.HasOne("Multiservicios.Models.Puesto", "Puesto")
                        .WithMany()
